...
namespace HerPace.Infrastructure.Migrations
{
    ...
    [Migration("20260218230335_AddResearchLibrary")]
    partial class AddResearchLibrary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HerPace.Core.Entities.PhaseStudyMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("RelevanceSummary")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.HasIndex("ResearchStudyId");

                    b.ToTable("phase_study_mappings", (string)null);
                });
            ...
            modelBuilder.Entity("HerPace.Core.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HerPace.Core.Entities.ResearchStudy", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("EvidenceTier")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("HerPace.Core.Entities.PhaseStudyMapping", b =>
                {
                    b.HasOne("HerPace.Core.Entities.ResearchStudy", "ResearchStudy")
                        .WithMany("PhaseStudyMappings")
            ...
            modelBuilder.Entity("HerPace.Core.Entities.ResearchStudy", b =>
                {
                    b.Navigation("PhaseStudyMappings");
                });

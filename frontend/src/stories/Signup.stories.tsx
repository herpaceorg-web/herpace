...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Signup page for HerPace. Users can create a new account with email and password. Includes password strength validation, password confirmation, terms agreement checkbox, and show/hide password toggles.',
      },
    },
  },
  tags: ['autodocs'],
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Default signup page with email, password, and confirm password fields. Includes password strength requirements (8+ characters, uppercase, lowercase, number) and terms agreement checkbox. Features password visibility toggles for both password fields.',
      },
    },
  },
}
...
export const GradientBlobs: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Signup page with soft gradient blobs using cycle phase colors (orange/ovulatory, green/follicular, purple/luteal, cyan/menstrual)',
      },
    },
  },
}
...
export const WavePattern: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Signup page with flowing wave pattern at bottom using ovulatory (orange) and follicular (green) colors',
      },
    },
  },
}
...
export const CircularRings: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Signup page with concentric circular rings representing the four cycle phases (red/menstrual outer, green/follicular, orange/ovulatory, purple/luteal inner)',
      },
    },
  },
}
...
export const MeshGradient: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Signup page with mesh gradient transitioning through all cycle phase colors (cyan→green→orange→purple)',
      },
    },
  },
}
...
export const AsymmetricBlocks: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Signup page with asymmetric color blocks in cycle phase colors positioned behind the form',
      },
    },
  },
}
...
export const SubtleGlow: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Signup page with subtle radial glow in ovulatory orange behind the form',
      },
    },
  },
}
...
export const HormoneWaves: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Signup page with hormone wave curves from the cycle chart as background. Uses the same four hormone colors: estrogen (golden), progesterone (burgundy), FSH (olive), and LH (blue).',
      },
    },
  },
}
